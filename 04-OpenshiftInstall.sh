...
nmcli con mod "$con" ipv4.method manual ipv4.addresses $IP  ipv4.dns 192.168.1.112 ipv4.gateway 192.168.1.155 connection.autoconnect yes
nmcli con up "$con"
...
#curl http://rhvh01.myhost.com/RHEL/Files/OpenShift/openshift-install-linux.tar_2.gz -o openshift-install-linux.tar.gz 
