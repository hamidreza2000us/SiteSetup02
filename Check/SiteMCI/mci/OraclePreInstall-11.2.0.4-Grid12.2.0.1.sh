...
export ORACLE_HOME=/u01/app/12.2.0.1/
...
sudo -u oracle unzip /u01/app/software/linuxx64_12201_grid_home.zip -d /u01/app/$GRID_VERSION/
chown --recursive grid:oinstall /u01/app/$GRID_VERSION/
sudo -u oracle unzip /u01/app/software/p13390677_112040_Linux-x86-64_1of7.zip -d /u01/app/$ORACLE_VERSION/
sudo -u oracle unzip /u01/app/software/p13390677_112040_Linux-x86-64_2of7.zip -d /u01/app/$ORACLE_VERSION/

#rpm -ihv /u01/app/$ORACLE_VERSION/grid/rpm/cvuqdisk*
rpm -ihv /u01/app/12.2.0.1/cv/rpm/cvuqdisk*
...
echo "grid ALL=(root) NOPASSWD:/u01/app/oraInventory/orainstRoot.sh,/u01/app/12.2.0.1/root.sh" >> /etc/sudoers
...
#/u01/app/12.2.0.1/gridSetup.sh -executePrereqs
