...
nmcli con reload
nmcli con add con-name team01 type team ifname team01 team.runner lacp ipv4.method manual ipv4.addresses ${IP}/24 ipv4.dns 172.17.58.97,172.17.58.98  ipv4.gateway ${GW}
nmcli con add con-name team-ens3f1 ifname ens3f1 type team-slave master team01
nmcli con add con-name team-ens3f0 ifname ens3f0 type team-slave master team01
nmcli con down "team-ens3f0"
nmcli con down "team-ens3f1"
nmcli con down "team01"
nmcli con reload
nmcli con up team-ens3f0
nmcli con up team-ens3f1
nmcli con up team01
nmcli con sh
EOF
...
ceph osd pool create rbd 512 512 onssd
