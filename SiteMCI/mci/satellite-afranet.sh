...
###############################Create Debug key###############################
curl -s -H "Accept:application/json" -k -u admin:${SatPass} https://${SatHost}.${Domain}/katello/api/v2/organizations/1/download_debug_certificate \
