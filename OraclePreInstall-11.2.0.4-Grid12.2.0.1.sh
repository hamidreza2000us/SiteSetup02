...
echo "grid ALL=(root) NOPASSWD:/u01/base/oraInventory/orainstRoot.sh,/u01/app/grid/product/12.2.0/grid/root.sh,/u01/app/grid/product/12.2.0/grid/OPatch/opatchauto" >> /etc/sudoers
...
echo "/u01/app/grid/product/12.2.0/grid/gridSetup.sh -executePrereqs"
...
echo "/u01/app/grid/product/12.2.0/grid/gridSetup.sh"
